...
public class UserActivity  extends AppCompatActivity{
                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                        ...
                        switch (item.getItemId()) {
                            case R.id.action_item1:
                                ...
                                Intent intent = new Intent(UserActivity.this, ProtocoloActivity.class);
                                startActivity(intent);
                                break;
                            case R.id.action_item2:
                                selectedFragment = ItemTwoFragment.newInstance();
                                PT1Activity PT1 = new PT1Activity();
                                Intent intentPT1 = new Intent(UserActivity.this, PT1Activity.class);
                                startActivity(intentPT1);
                                break;
                            case R.id.action_item3:
                                selectedFragment = ItemThreeFragment.newInstance();
                                PT2Activity PT2 = new PT2Activity();
                                Intent intentPT2 = new Intent(UserActivity.this, PT2Activity.class);
    ...
    public void menuizquierdo(){
        drawerLayout = (DrawerLayout)findViewById(R.id.drawer_layout8);
    ...
    private void election(String opcion){
        switch (opcion){
            ...
            case "op5":
                ...
                break;
            case "op6":
                Intent intent6 = new Intent(UserActivity.this, NotificacionesActivity.class);
                startActivity(intent6);
                break;
            case "op7":
                Intent intent7 = new Intent(UserActivity.this, UserActivity.class);
                startActivity(intent7);
                break;
            case "op8":
                Intent intent8 = new Intent(UserActivity.this, Main2Activity.class);
