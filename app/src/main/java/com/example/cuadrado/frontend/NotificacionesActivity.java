...
/**
 * Created by cuadrado on 29/10/2017.
 */
...
public class NotificacionesActivity extends AppCompatActivity {
    ...
    private static final String TAG = NotificacionesActivity.class.getSimpleName();
                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                        ...
                        switch (item.getItemId()) {
                            case R.id.action_item1:
                                ...
                                Intent intent = new Intent(NotificacionesActivity.this, ProtocoloActivity.class);
                            ...
                            case R.id.action_item2:
                                ...
                                Intent intentPT1 = new Intent(NotificacionesActivity.this, PT1Activity.class);
                            ...
                            case R.id.action_item3:
                                ...
                                Intent intentPT2 = new Intent(NotificacionesActivity.this, PT2Activity.class);
    ...
    private void election(String opcion){
        switch (opcion){
            ...
            case "op5":
                ...
                break;
            case "op6":
                Intent intent6 = new Intent(NotificacionesActivity.this, NotificacionesActivity.class);
                startActivity(intent6);
                break;
            case "op7":
                Intent intent7 = new Intent(NotificacionesActivity.this, UserActivity.class);
                startActivity(intent7);
                break;
            case "op8":
                Intent intent8 = new Intent(NotificacionesActivity.this, Main2Activity.class);
    ...
    public void pantalla(View view){
        Intent intentsiguiente = new Intent(NotificacionesActivity.this, RevisionActivity.class);
